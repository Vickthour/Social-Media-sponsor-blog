            ...
            if ($values["item_id"] == $_GET["id"]){
                unset($_SESSION['shopping_cart'][$keys]);
                 ...
                 exit;
                      ...
                      if(isset($_GET['ubas8'])){
                      $details=$con->query("SELECT * from posts where post_name='Instagram' AND category='Likes' ");
                      }
                      else if(isset($_GET['aya7t'])){
                      $details=$con->query("SELECT * from posts where post_name='Instagram' AND category='Followers' ");
                      }
                      else if(isset($_GET['s2gst'])){
                      $details=$con->query("SELECT * from posts where post_name='Instagram' AND category='Comments' ");

                      }
                      else if(isset($_GET['jaysw%h'])){
                      $details=$con->query("SELECT * from posts where post_name='Instagram' AND category='Views' ");
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu second mt-2" style="display: none;">
                                ...
                                <a class="dropdown-item scroll" href="../pages/contact.php">Account Mangement</a>
                            </div>
                        </li>
                ...
                <div class="container">
                        ...
                        ?>
                                  ...
                                  <div class="transmitv single-item">
                                    ...
                                    <span class="price" style="font-weight: bolder;font-family: 'Work Sans',sans-serif;">
                                        <?php echo '#'.$data['price'] * 50 ?> - <?php echo '#'.$data['price'] * 20000 ?>
                                        
                                      </span>
                                   <form action="instagram.php?action&id=<?php echo $data['id']; ?>" method="post" oninput="x.value=parseInt(a.value) * parseInt(b.value)" >
                                        ...
                                        <select class="add-to-cart_bad text-center" name="quantity">
                                            <option id="b" name="quantity" value="50" > 50 </option>
                                            <option id="b" name="quantity" value="100" > 100 </option>
                                            <option id="b" name="quantity" value="200" > 200 </option>
                                            <option id="b" name="quantity" value="500" > 500 </option>
                                            <option id="b" name="quantity" value="1000" > 1K </option>
                                            <option id="b" name="quantity" value="2000" > 2K </option>
                                            <option id="b" name="quantity" value="3000" > 3K </option>
                                            <option id="b" name="quantity" value="5000" > 5K </option>
                                            <option id="b" name="quantity" value="10000" > 10K </option>
                                            <option id="b" name="quantity" value="15000" > 15K </option>
                                            <option id="b" name="quantity" value="20000" > 20K </option>
                  ...
                  <div>
                    ...
                    <?php } } else{
                            ...
                            echo "<div class='alert alert-danger alert-dismissible col-md-6' style='margin:100px;'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>No Item !</strong></div>";
                                  } 
                    ?>                     
                </div>
      </section> 
    ...
    <section class="w3l-footer-22 container-fluid">
