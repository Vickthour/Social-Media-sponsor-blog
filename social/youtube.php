            ...
            if ($values["item_id"] == $_GET["id"]){
                unset($_SESSION['shopping_cart'][$keys]);
                 ...
                 exit;
                      ...
                      if(isset($_GET['ujfyf4'])){
                      $details=$con->query("SELECT * from posts where post_name='Youtube' AND category='Likes' ");
                      }
                      else if(isset($_GET['4hdfy'])){
                      $details=$con->query("SELECT * from posts where post_name='Youtube' AND category='Subscriber' ");
                      }
                      else if(isset($_GET['dhyfc'])){
                      $details=$con->query("SELECT * from posts where post_name='Youtube' AND category='Comments' ");

                      }
                      else if(isset($_GET['chdud4f'])){
                      $details=$con->query("SELECT * from posts where post_name='Youtube' AND category='Views' ");

                      }else if(isset($_GET['jgfyr'])){
                      $details=$con->query("SELECT * from posts where post_name='Youtube' AND category='Share' ");
                    ...
                    <div class="col-lg-3 col-6 product-incfhny mt-4">
                        ...
                        <div class="product-grid2 transmitv">
                            ...
                            <div class="product-content">
                                ...
                                <span class="price"><?php echo  '#' . ($data['price'] * 50); ?>  - <?php echo '#'.($data['price'] * 20000); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php } } ?>
